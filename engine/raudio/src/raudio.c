...
static Wave LoadFLAC(const char *fileName)
{
    ...
    fileData, fileSize, &wave.channels, &wave.sampleRate, (drflac_uint64 *)&totalSampleCount);
...
static Wave LoadMP3(const char *fileName)
{
    ...
    wave.data = drmp3_open_memory_and_read_f32(fileData, fileSize, &config, (drmp3_uint64 *)&totalFrameCount);
