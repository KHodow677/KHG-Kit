...
typedef float (*cpMarchSampleFunc)(phy_vect point, void *data);
...
typedef void (*cpMarchSegmentFunc)(phy_vect v0, phy_vect v1, void *data);
...
void cpMarchSoft(
  phy_bb bb, unsigned long x_samples, unsigned long y_samples, float threshold,
