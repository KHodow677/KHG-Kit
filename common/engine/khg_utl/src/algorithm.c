...
static void reverse(void *first, void *last, unsigned int size) {
  char *a = (char *)first;
...
static void merge(void *base, unsigned int low, unsigned int mid, unsigned int high, unsigned int size, utl_compare_func comp, void *temp) {
  unsigned int i = low, j = mid, k = 0;
  while (i < mid && j < high) {
...
void *utl_algorithm_find_end(const void *base1, unsigned int num1, unsigned int size1, const void *base2, unsigned int num2, unsigned int size2, utl_compare_func comp) {
  ...
  for (unsigned int i = 0; i <= num1 - num2; ++i) {
    bool found = true;
...
utl_pair utl_algorithm_mismatch(const void *base1, unsigned int num1, unsigned int size1, const void *base2, unsigned int num2, unsigned int size2, utl_compare_func_bool comp) {
  const char *ptr1 = (const char *)base1;
  const char *ptr2 = (const char *)base2;
  unsigned int min_num = num1 < num2 ? num1 : num2;
...
const void *utl_algorithm_search_n(const void *first, const void* last, unsigned int size, unsigned int count, const void *val, utl_compare_func_bool comp) {
...
void utl_algorithm_replace_if(void *base, unsigned int num, unsigned int size, const void *new_val, utl_bool_predicate_func pred) {
  if (!base) {
