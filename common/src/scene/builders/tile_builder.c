...
void build_ovr_tile(const unsigned int tile_id, const phy_vector2 pos) {
  ...
  element_comp_render comp_renderer_ci = { .tex_id_loc = NAMESPACE_TASKING()->get_location_tex_str("EMPTY_TEXTURE"), .ovr_tile = (ovr_tile_info){ tile_id, pos }, .render_layer = 0, .parallax_value = 1.0f, .flipped = false };
