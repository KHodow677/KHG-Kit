...
void build_player(const int min_tex_id, const int max_tex_id, const float x, const float y, const int render_layer) {
  ...
  comp_physics_constructor_info comp_physics_ci = { PHYSICS_BOX, 166.0f, 201.0f, 1.0f, NV_VECTOR2(x, y), 0.0f, true, true };
  ...
  comp_light_constructor_info comp_light_ci = { cp->body, (light){ (vec2s){ 0.0, 0.0 }, 250.0f }, NV_VECTOR2(0.0f, 0.0f) };
