...
void generate_textures() {
  ...
  TEXTURE_ASSET_REF[GRASS_0] = (texture_asset){ "environment/Grass1", "png", 264, 264 };
  TEXTURE_ASSET_REF[GRASS_1] = (texture_asset){ "environment/Grass2", "png", 264, 264 };
  TEXTURE_ASSET_REF[BUILDING_0] = (texture_asset){ "environment/Building00", "png", 264, 264 };
  TEXTURE_ASSET_REF[BUILDING_1] = (texture_asset){ "environment/Building01", "png", 264, 264 };
  TEXTURE_ASSET_REF[BUILDING_2] = (texture_asset){ "environment/Building02", "png", 264, 264 };
  TEXTURE_ASSET_REF[BUILDING_3] = (texture_asset){ "environment/Building03", "png", 264, 264 };
  TEXTURE_ASSET_REF[BUILDING_4] = (texture_asset){ "environment/Building04", "png", 264, 264 };
  TEXTURE_ASSET_REF[BUILDING_5] = (texture_asset){ "environment/Building05", "png", 264, 264 };
  TEXTURE_ASSET_REF[BUILDING_6] = (texture_asset){ "environment/Building06", "png", 264, 264 };
  TEXTURE_ASSET_REF[BUILDING_7] = (texture_asset){ "environment/Building07", "png", 264, 264 };
  TEXTURE_ASSET_REF[BUILDING_8] = (texture_asset){ "environment/Building08", "png", 264, 264 };
  TEXTURE_ASSET_REF[BUILDING_9] = (texture_asset){ "environment/Building09", "png", 264, 264 };
  TEXTURE_ASSET_REF[BUILDING_10] = (texture_asset){ "environment/Building10", "png", 264, 264 };
  TEXTURE_ASSET_REF[BUILDING_11] = (texture_asset){ "environment/Building11", "png", 264, 264 };
  TEXTURE_ASSET_REF[BUILDING_12] = (texture_asset){ "environment/Building12", "png", 264, 264 };
