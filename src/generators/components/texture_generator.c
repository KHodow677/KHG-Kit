...
void generate_textures() {
  ...
  TEXTURE_ASSET_REF[FENCE_0] = (texture_asset){ "environment/Fence00", "png", 136, 136, SEGMENT_NONE, 20 };
  TEXTURE_ASSET_REF[FENCE_1] = (texture_asset){ "environment/Fence01", "png", 136, 136, SEGMENT_BOTTOM, 20 };
  TEXTURE_ASSET_REF[FENCE_2] = (texture_asset){ "environment/Fence02", "png", 136, 136, SEGMENT_BOTTOM, 20 };
  TEXTURE_ASSET_REF[FENCE_3] = (texture_asset){ "environment/Fence03", "png", 136, 136, SEGMENT_NONE, 20 };
  TEXTURE_ASSET_REF[FENCE_4] = (texture_asset){ "environment/Fence04", "png", 136, 136, SEGMENT_RIGHT, 20 };
  TEXTURE_ASSET_REF[FENCE_5] = (texture_asset){ "environment/Fence05", "png", 136, 136, SEGMENT_LEFT, 20 };
  TEXTURE_ASSET_REF[FENCE_6] = (texture_asset){ "environment/Fence06", "png", 136, 136, SEGMENT_RIGHT, 20 };
  TEXTURE_ASSET_REF[FENCE_7] = (texture_asset){ "environment/Fence07", "png", 136, 136, SEGMENT_LEFT, 20 };
  TEXTURE_ASSET_REF[FENCE_8] = (texture_asset){ "environment/Fence08", "png", 136, 136, SEGMENT_NONE, 20 };
  TEXTURE_ASSET_REF[FENCE_9] = (texture_asset){ "environment/Fence09", "png", 136, 136, SEGMENT_TOP, 20 };
  TEXTURE_ASSET_REF[FENCE_10] = (texture_asset){ "environment/Fence10", "png", 136, 136, SEGMENT_TOP, 20 };
  TEXTURE_ASSET_REF[FENCE_11] = (texture_asset){ "environment/Fence11", "png", 136, 136, SEGMENT_NONE, 20 };
  ...
  TEXTURE_ASSET_REF[HANGAR] = (texture_asset){ "Depot", "png", 276, 304, SEGMENT_BOTTOM_LEFT_RIGHT, 0 };
