...
void generate_textures() {
  ...
  TEXTURE_ASSET_REF[HEDGE_0] = (texture_asset){ "environment/Hedge00", "png", 136, 136, SEGMENT_TOP_LEFT };
  TEXTURE_ASSET_REF[HEDGE_1] = (texture_asset){ "environment/Hedge01", "png", 136, 136, SEGMENT_TOP };
  TEXTURE_ASSET_REF[HEDGE_2] = (texture_asset){ "environment/Hedge02", "png", 136, 136, SEGMENT_TOP_RIGHT };
  TEXTURE_ASSET_REF[HEDGE_3] = (texture_asset){ "environment/Hedge03", "png", 136, 136, SEGMENT_LEFT };
  TEXTURE_ASSET_REF[HEDGE_4] = (texture_asset){ "environment/Hedge04", "png", 136, 136, SEGMENT_NONE };
  TEXTURE_ASSET_REF[HEDGE_5] = (texture_asset){ "environment/Hedge05", "png", 136, 136, SEGMENT_RIGHT };
  TEXTURE_ASSET_REF[HEDGE_6] = (texture_asset){ "environment/Hedge06", "png", 136, 136, SEGMENT_BOTTOM_LEFT };
  TEXTURE_ASSET_REF[HEDGE_7] = (texture_asset){ "environment/Hedge07", "png", 136, 136, SEGMENT_BOTTOM };
  TEXTURE_ASSET_REF[HEDGE_8] = (texture_asset){ "environment/Hedge08", "png", 136, 136, SEGMENT_BOTTOM_RIGHT };
  TEXTURE_ASSET_REF[HEDGE_9] = (texture_asset){ "environment/Hedge09", "png", 136, 136, SEGMENT_NONE };
  TEXTURE_ASSET_REF[HEDGE_10] = (texture_asset){ "environment/Hedge10", "png", 136, 136, SEGMENT_NONE };
  TEXTURE_ASSET_REF[HEDGE_11] = (texture_asset){ "environment/Hedge11", "png", 136, 136, SEGMENT_NONE };
  TEXTURE_ASSET_REF[HEDGE_12] = (texture_asset){ "environment/Hedge12", "png", 136, 136, SEGMENT_NONE };
  ...
  TEXTURE_ASSET_REF[PARTICLE_2_0] = (texture_asset){ "particle/p2/00", "png", 100, 109, SEGMENT_NONE };
  TEXTURE_ASSET_REF[PARTICLE_2_1] = (texture_asset){ "particle/p2/01", "png", 100, 109, SEGMENT_NONE };
  TEXTURE_ASSET_REF[PARTICLE_2_2] = (texture_asset){ "particle/p2/02", "png", 100, 109, SEGMENT_NONE };
  TEXTURE_ASSET_REF[PARTICLE_2_3] = (texture_asset){ "particle/p2/03", "png", 100, 109, SEGMENT_NONE };
  TEXTURE_ASSET_REF[PARTICLE_2_4] = (texture_asset){ "particle/p2/04", "png", 100, 109, SEGMENT_NONE };
