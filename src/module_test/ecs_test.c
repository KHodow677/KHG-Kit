...
ecs_id_t test_pos_comp;
ecs_id_t test_vel_comp;
ecs_id_t test_rect_comp;

ecs_id_t test_system_1;
ecs_id_t test_system_2;
ecs_id_t test_system_3;

void test_register_components(ecs_t *ecs) {
...
ecs_ret_t test_system_update(ecs_t *ecs, ecs_id_t *entities, int entity_count, ecs_dt_t dt, void *udata) {
  (void)ecs;
  (void)dt;
  (void)udata;
...
void test_register_systems(ecs_t *ecs) {
