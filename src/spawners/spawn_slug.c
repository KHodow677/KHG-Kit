...
generic_entity *spawn_slug(float x, float y, float angle, phy_vect *init_path, int init_path_length, float health) {
  generic_entity ge;
  ...
  generate_slug(&stored_ge->slug, x, y, angle, init_path, init_path_length, health);
  return stored_ge;
}
