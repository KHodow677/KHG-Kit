...
void generate_textures() {
  ...
  TEXTURE_ASSET_REF[PLAYER_IDLE_0] = (texture_asset){ "player/idle/player_idle_0", "png", 300, 256, 0 };
  TEXTURE_ASSET_REF[PLAYER_IDLE_1] = (texture_asset){ "player/idle/player_idle_1", "png", 300, 256, 0 };
  TEXTURE_ASSET_REF[PLAYER_IDLE_2] = (texture_asset){ "player/idle/player_idle_2", "png", 300, 256, 0 };
  TEXTURE_ASSET_REF[PLAYER_IDLE_3] = (texture_asset){ "player/idle/player_idle_3", "png", 300, 256, 0 };
  TEXTURE_ASSET_REF[PLAYER_IDLE_4] = (texture_asset){ "player/idle/player_idle_4", "png", 300, 256, 0 };
  TEXTURE_ASSET_REF[PLAYER_IDLE_5] = (texture_asset){ "player/idle/player_idle_5", "png", 300, 256, 0 };
  TEXTURE_ASSET_REF[PLAYER_IDLE_6] = (texture_asset){ "player/idle/player_idle_6", "png", 300, 256, 0 };
  TEXTURE_ASSET_REF[PLAYER_IDLE_7] = (texture_asset){ "player/idle/player_idle_7", "png", 300, 256, 0 };
