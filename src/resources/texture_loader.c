...
void generate_textures() {
  ...
  TEXTURE_ASSET_REF[PLAYER_WALK_0] = (texture_asset){ "player/walk/walk_00", "png", 189, 195, 0 };
  TEXTURE_ASSET_REF[PLAYER_WALK_1] = (texture_asset){ "player/walk/walk_01", "png", 189, 195, 0 };
  TEXTURE_ASSET_REF[PLAYER_WALK_2] = (texture_asset){ "player/walk/walk_02", "png", 189, 195, 0 };
  TEXTURE_ASSET_REF[PLAYER_WALK_3] = (texture_asset){ "player/walk/walk_03", "png", 189, 195, 0 };
  TEXTURE_ASSET_REF[PLAYER_WALK_4] = (texture_asset){ "player/walk/walk_04", "png", 189, 195, 0 };
  TEXTURE_ASSET_REF[PLAYER_WALK_5] = (texture_asset){ "player/walk/walk_05", "png", 189, 195, 0 };
  TEXTURE_ASSET_REF[PLAYER_WALK_6] = (texture_asset){ "player/walk/walk_06", "png", 189, 195, 0 };
  TEXTURE_ASSET_REF[PLAYER_WALK_7] = (texture_asset){ "player/walk/walk_07", "png", 189, 195, 0 };
  TEXTURE_ASSET_REF[PLAYER_WALK_8] = (texture_asset){ "player/walk/walk_08", "png", 189, 195, 0 };
  TEXTURE_ASSET_REF[PLAYER_WALK_9] = (texture_asset){ "player/walk/walk_09", "png", 189, 195, 0 };
